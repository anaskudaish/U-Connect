...
<head>
    <meta charset="UTF-8">
    <title>Beziehungen hinzufügen</title>
...
<div class="container">
    <div class="main-body">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <h2>Beziehungen hinzufügen {{$kontakt_wo_beziehungen_bearebitet_werden['vorname']}} {{$kontakt_wo_beziehungen_bearebitet_werden['nachname']}}</h2>
                    <div class="card-body">
                        ...
                        <div class="second">
                            ...
                            <form id="update" method="post" action="/beziehungenhinzufuegen" oninput="numerisch.value=update_entfernen.value" onsubmit="document.getElementById('update')['beziehung_zu'].value = document.getElementById('Beziehungen').value;">
                        ...
                        <div class="third">
                            ...
                            <form id="addRelationship" method="post" action="/beziehungenhinzufuegen"  oninput="numerisch.value=bewertung.value" onsubmit="document.getElementById('addRelationship')['beziehungen_hinzufügen'].value = document.getElementById('beziehungen_hinzufügen').value;">
                                ...
                                <div>
                                    <form method="post" action="/Neuer_Kontakt">
                                        <input type="submit" name="zurück" class="btn btn-primary px-4" value="Zurück">
                                        <input type="hidden" name="id_kontakt" value="}">
                                        <input type="hidden" name="submitted" value="1" >
                                    </form>
                                </div>
